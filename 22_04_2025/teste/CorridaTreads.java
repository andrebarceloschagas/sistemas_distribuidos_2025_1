public class CorridaTreads extends Thread {
    // Construtor da classe CorridaTreads
    public CorridaTreads(String nome) {
    ...
    // Quando você chama o método start() em um objeto CorridaTreads, 
